...
from rdagent.scenarios.qlib.developer.utils import feature_columns, normalize_model_type, process_factor_data
...
class QlibFactorRunner(CachedRunner[QlibFactorExperiment]):
    ...
    def get_cache_extra_key(self) -> str:
        ...
        return "|".join([s.train_start, s.train_end, s.valid_start, s.valid_end, s.test_start, str(s.test_end)])
    ...
    def develop(self, exp: QlibFactorExperiment) -> QlibFactorExperiment:
        ...
        if exp.based_experiments:
            ...
            new_columns = feature_columns(combined_factors.columns)
            ...
            if exist_sota_model_exp:
                ...
                sota_model_type = normalize_model_type(sota_model_exp.sub_tasks[0].model_type)
            ...
            if exp.base_feature_codes:
                ...
                new_columns = feature_columns(factors.columns)
