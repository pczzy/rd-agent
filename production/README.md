...
**费率来自回单实测，不是费率表。** 三张回单跨两只股票、两个日期，用同一个费率全部还原到分：
2026-09-07 兆易创新 38,245→9.00、38,255→9.01，2026-08-27 山东黄金 35,000→8.24，
合计 26.25/111,500 = 万分之 2.354。同一张卖出单还把另两项也验证了：印花税 17.50/35,000
= 0.05%、过户费 0.35/35,000 = 0.001%，三项加总 26.09 元与回单合计一致 —— 说明卖出侧没有
遗漏的科目。回单只列佣金/过户费/印花税三行、没有单列规费，
